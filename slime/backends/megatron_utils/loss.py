...
def get_responses(
    ...
    *,
    ...
    # `Tensor.div(1.0)` materializes another full `[T, V]` tensor.  For large
    # vocabularies (for example Qwen3.5's 248k action space), that otherwise
    # identical copy can consume more than 15 GiB and dominate both peak
    # memory and step time.  Preserve the exact identity transform as a view.
